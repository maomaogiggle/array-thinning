...
plot(theta_plot,y);
hold on;
fdd = 10^(-30/20)*ones(length(theta_plot),1);
fdd(701:1101) = 1;
plot(theta_plot,20*log10(fdd),'r');
fddd = 10^(-30/20)*ones(length(theta_plot),1);
fddd(651:1151) = 0.95;
plot(theta_plot,20*log10(fddd),'c');
